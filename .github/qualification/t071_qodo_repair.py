...
start = text.index("## 13. Metrics handoff")
end = text.index("## 14. Rejection and maintenance")
new_section = """## 13. Metrics and observation protocol handoff
