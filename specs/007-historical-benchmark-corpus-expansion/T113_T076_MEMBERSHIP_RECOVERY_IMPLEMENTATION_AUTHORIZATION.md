...
**Canonical authorization base:** `00a87a95a390eb79366948594ec4c2126fdfacd7`  
**Canonical authorization-base tree:** `f1ae11d8e710fc4061d79f06a2d8bbadc2ac5d1b`
...
The first authorization candidate, PR #220 at `da5b38d2a1f86745c7bfb9eb21193701c130618f`, remains immutable unqualified evidence because original-attempt Project CI run `34136462682` failed the Windows Node 24 lane on an unrelated pre-existing T054 integration-test timeout. That candidate was closed unmerged and is not reused.

The T054 supported-platform reliability repair is canonically merged as:

- repair issue: #221, CLOSED / COMPLETED;
- repair PR: #222, MERGED;
- repair head: `1450f4351f91ea140a0157f94d76c45be197a326`;
- repair merge: `00a87a95a390eb79366948594ec4c2126fdfacd7`;
- repair merge tree: `f1ae11d8e710fc4061d79f06a2d8bbadc2ac5d1b`;
- ordered parents:
  1. `4719d159ac7aa2b1fcd8e4d73bd37c82f7db6cfa`;
  2. `1450f4351f91ea140a0157f94d76c45be197a326`;
- GitHub merge verification: `verified=true`, `reason=valid`;
- repair scope: one test-only timeout bound change, `60_000` -> `180_000`, with the test body/assertions/fixture/product behavior unchanged;
- exact-head Self Verification: SUCCESS;
- exact-head Project CI: original-attempt six required lanes SUCCESS;
- independent exact-head review: no material code, security, or Spec 007 authority findings.

No CI/review evidence from PR #220 is reused by this fresh candidate.
