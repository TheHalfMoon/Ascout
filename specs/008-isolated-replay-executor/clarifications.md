...
## Q6 — How is exact source binding preserved?
...
## Q7 — Does GitHub-hosted runner network violate hermeticity?
...
## Q8 — How is Yarn 1.22.22 provided?
...
## Q9 — Why install/build Ascout before replay?
...
## Q10 — Are donor dependencies cached?
...
## Q12 — Does Spec 008 reopen candidate selection?
...
## Q13 — Does planning authorize the workflow or run refs?

No. Canonical planning closure only establishes the design. A separate explicit implementation authorization must name the exact one-file workflow mutation and the exact task-run ref creation authority before either is used.