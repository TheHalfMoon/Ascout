...
This artifact is the fresh successor repository authorization candidate for Issue #299. It grants no T124 implementation authority until it is independently qualified, guarded-merged, post-merge verified, becomes canonical, and Issue #299 closes `CLOSED_CANONICAL / EFFECTIVE`.

Failed authorization PRs #301 and #310 remain preserved and unmerged. No CI, review, commit, or qualification evidence from either failed candidate is reused by this successor candidate.
...
- fresh successor authorization base: `7138c704b5aecdd589c310a9add48ec224ec26c2`.

The authoritative T124 contract remains the canonically merged Spec 013 planning package.

## CI-stability prerequisite closeout

The forward-only CI-stability recovery required by Issue #299 is closed canonical before this successor artifact exists:

- Issue #302 / PR #303: T052 + T103 local deadline repair;
- Issue #304 / PR #305: T019 local deadline follow-up;
- Issue #306 / PR #307: T051 local deadline follow-up;
- Issue #308 / PR #309: T062 local deadline follow-up;
- Issue #311 / PR #312: T107 exact-tree local deadline follow-up;
- final canonical repair-chain main: `7138c704b5aecdd589c310a9add48ec224ec26c2`;
- final required push-triggered Project CI run `34644006749`: attempt 1 / SUCCESS / all six required OS/Node lanes SUCCESS.

Issues #302, #304, #306, #308, and #311 are closed completed. PR #310 remains closed unmerged as the preserved failed authorization attempt that exposed the T107 timing defect. This artifact is created from the exact final repaired canonical main and must qualify from scratch.
